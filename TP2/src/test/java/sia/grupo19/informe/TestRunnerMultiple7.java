...
public class TestRunnerMultiple7 {
    ...
    public void test01() throws Exception {
        // ELITE
        Parser parser = new Parser("./test-configs-m7/test01.txt", true);
    ...
    public void test02() throws Exception {
        // STOCHASTIC
        Parser parser = new Parser("./test-configs-m7/test02.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
    ...
    public void test03() throws Exception {
        // TRUNCATED
        Parser parser = new Parser("./test-configs-m7/test03.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
    ...
    public void test04() throws Exception {
        // ROULETTE
        Parser parser = new Parser("./test-configs-m7/test04.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
    ...
    public void test05() throws Exception {
        // RANK
        Parser parser = new Parser("./test-configs-m7/test05.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
    ...
    public void test06() throws Exception {
        // TOURNAMENT
        Parser parser = new Parser("./test-configs-m7/test06.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
    ...
    public void test07() throws Exception {
        // BOLTZMAN
        Parser parser = new Parser("./test-configs-m7/test07.txt", true);
        Genetic genetic = new Genetic(parser.getParams());
        Solution solution = genetic.runEvolution();
        System.out.println(solution.getOptimalIndividuo().getSerialized());
